...
function page() {
  return (
    <div>
      <NavBar />
      <PageHeader paths={["Portfolio"]} url="Bookchoice">
        Bookchoice
          ...
          <div className="grid lg:grid-cols-6 gap-10 relative">
            <div className="lg:col-span-4 order-2">
              ...
              <div className="columns-1 lg:columns-2 gap-y-10  space-y-4">
                {["/projects/bookchoice/1.png", "/projects/bookchoice/2.png", "/projects/bookchoice/3.png"].map((e, index) => (
                  ...
                  <div className="p-8">
                    <div className="border-b border-white/5 pb-5">
                      ...
                      <p className="font-light text-white/80">
                        Bookchoice – Unlimited Stories in Your Pocket
                      </p>
                    </div>
