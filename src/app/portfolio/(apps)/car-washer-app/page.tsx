...
function page() {
  return (
    <div>
      <NavBar />
      <PageHeader paths={["Portfolio"]} url="Car Washer App">
        Car Washer <span className="text-primary font-semibold">App</span>
      </PageHeader>
          ...
          <div className="grid lg:grid-cols-6 gap-10 relative">
            <div className="lg:col-span-4 order-2">
              ...
              <div className="columns-1 lg:columns-2 gap-y-10  space-y-4">
                {[
                  "/projects/car-washer-app/1.png",
                  "/projects/car-washer-app/2.png",
                  "/projects/car-washer-app/3.png",
                ].map((e, index) => (
              ...
              <div className="flex flex-col gap-3">
                <FaqCard
                  ...
                  description="Development timelines vary based on the complexity of the app, but typically, a basic app can take 8-12 weeks, while more complex apps may take 4-6 months or longer. We provide detailed timelines after understanding your specific requirements."
                />
                <FaqCard
                  title="Do you provide design services, or do I need to provide the app design?"
                  description="We offer comprehensive UI/UX design services to create user-friendly and visually appealing apps. If you already have designs, we can work with those as well."
                />
                <FaqCard
                  title="Will you assist with publishing the app on app stores?"
                  description="Yes, we handle the entire app store submission process, including meeting platform guidelines and managing approvals to ensure a smooth launch."
                />
                <FaqCard
                ...
                <div className="bg-[#14170e]/30 backdrop-blur-3xl border-primary/5 border rounded-3xl">
                  <div className="p-8">
                    <div className="border-b border-white/5 pb-5">
                      ...
                      <p className="font-light text-white/80">Car Washer App</p>
                    </div>
                    ...
                    <div className="pt-5">
                      ...
                      <p className="font-light text-white/80">3 Months</p>
                    </div>
                  </div>
                </div>
