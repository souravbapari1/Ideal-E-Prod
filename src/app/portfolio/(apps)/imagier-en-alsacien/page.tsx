...
function page() {
  return (
    <div>
      <NavBar />
      <PageHeader paths={["Portfolio"]} url="Moneylife News & Views">
          ...
          <div className="grid lg:grid-cols-6 gap-10 relative">
            <div className="lg:col-span-4 order-2">
              ...
              <div className="columns-1 lg:columns-2 gap-y-10  space-y-4">
                {[
                  "/projects/imagier-en-alsacien/1.png",
                  "/projects/imagier-en-alsacien/2.png",
                  "/projects/imagier-en-alsacien/3.png",
                ].map((e, index) => (
                ...
                <div className="bg-[#14170e]/30 backdrop-blur-3xl border-primary/5 border rounded-3xl">
                  <div className="p-8">
                    ...
                    <div className="pt-5">
                      ...
                      <p className="font-light text-white/80">5 Months</p>
                    </div>
                  </div>
                </div>
