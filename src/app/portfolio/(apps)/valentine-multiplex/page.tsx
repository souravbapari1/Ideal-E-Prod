...
function page() {
  return (
    <div>
      <NavBar />
      <PageHeader paths={["Portfolio"]} url="Valentine Multiplex">
       Valentine Multiplex{" "}
          ...
          <div className="grid lg:grid-cols-6 gap-10 relative">
            <div className="lg:col-span-4 order-2">
              ...
              <div className="columns-1 lg:columns-2 gap-y-10  space-y-4">
                {["/projects/valentine-multiplex/1.png", "/projects/valentine-multiplex/2.png", "/projects/valentine-multiplex/3.png"].map((e, index) => (
