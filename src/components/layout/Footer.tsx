  ...
  return (
    <div className="border-t border-white/10 mt-32">
      <div className="container ">
        <div className="w-full grid lg:grid-cols-6 md:grid-cols-3 md:gap-3 gap-10 md:py-20 py-10 ">
          <div className=" lg:col-span-2">
            <Link href="/">
              <Image
                src="/logo.png"
                className="h-10 mb-10 w-auto md:-mt-5"
                width={1000}
                height={1000}
                alt=""
              />
            ...
            <div className="flex justify-start items-center gap-4 mt-6">
              ...
              <p className="text-white/90 text-xl ">+91-9315509430</p>
            </div>
            <div className="flex justify-start items-center gap-4 mt-5">
              <div className="w-8 h-8 rounded-full bg-primary flex justify-center items-center text-secondary  ">
                <MdEmail size={16} />
              </div>
              <p className="text-white/90 text-xl ">info@idealedesigns.com</p>
            </div>
          </div>
